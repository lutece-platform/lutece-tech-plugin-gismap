...
parameters.push(parameters['WMS-Layer2']=['4','Popup_WMS','AGS-MPS','http://xdir-infmpub-pr.ressources.paris.mdp/arcgis/rest/services/','DU/ADS_Gerco',true]);
parameters.push(parameters['WFS1']=['Lieu','AGS','http://capgeo.sig.paris.fr/arcgis/rest/services/capgeo_dasco/DASCO_Evenements_ecoles/FeatureServer/0','EPSG:2154','ARRONDISSEMENT = 4']);
